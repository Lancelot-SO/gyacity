...
export function GCityMark({ size = 40, strokeColor, accentColor, style }) {
  const sc = strokeColor || V2.cream;
  const ac = accentColor || V2.brass;
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', flexShrink: 0, ...style }}>
...
export function V2Mark({ size = 14, color, style }) {
